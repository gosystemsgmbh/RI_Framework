...
namespace RI.Framework.Bus
{
    ...
    ///     </para>
    ///     <para>
    ///         When sending a message to a single recipient, the sender waits for the (first) response as long as <see cref="DefaultSingleResponseTimeout" />, throwing <see cref="BusResponseTimeoutException" /> if no response was received within that time.
    ...
    ///         If no number of expected responses is specified, the send task completes always (more or less) exactly after the time specified by <see cref="DefaultBroadcastResponseTimeout" />.
    ///         Either way, the send task always completes no later than <see cref="DefaultBroadcastResponseTimeout" /> after the message was sent, ignoring all responses received afterwards.
    ...
    public interface IBus : IDisposable, ISynchronizable, ILogSource
    {
        ...
        /// <summary>
        ///     Gets or sets the default exception handler while sending.
        /// </summary>
        /// <value>
        ///     The default exception handler while sending.
        /// </value>
        /// <remarks>
        ///     <note type="implement">
        ...
        /// <summary>
        ///     Gets or sets the default exception handler while receiving.
        /// </summary>
        /// <value>
        ///     The default exception handler while receiving.
        /// </value>
        /// <remarks>
        ///     <note type="implement">
        ///         The default value should be null.
        ...
        /// <summary>
        ///     Gets or sets the default timeout for collecting responses for broadcast messages.
        /// </summary>
        /// <value>
        ///     The default timeout for collecting responses for broadcast messages.
        /// </value>
        /// <remarks>
        ///     <note type="implement">
        ...
        TimeSpan DefaultBroadcastResponseTimeout { get; set; }

        /// <summary>
        ///     Gets or sets whether exception forwarding is used by default while sending.
        /// </summary>
        /// <value>
        ///     true if exception forwarding is used by default while sending, false otherwise.
        /// </value>
        /// <remarks>
        ///     <note type="implement">
        ...
        /// <summary>
        ///     Gets or sets whether exception forwarding is used by default while receiving.
        /// </summary>
        /// <value>
        ///     true if exception forwarding is used by default while receiving, false otherwise.
        /// </value>
        /// <remarks>
        ///     <note type="implement">
        ///         The default value should be true.
        ...
        /// <summary>
        ///     Gets or sets whether broken connections are ignored by send operations by default.
        /// </summary>
        /// <value>
        ///     true if broken connections are ignored by send operations by default, false otherwise.
        /// </value>
        /// <remarks>
        ///     <note type="implement">
        ...
        ///     </note>
        /// </remarks>
        bool DefaultSendToGlobal { get; set; }

        /// <summary>
        ///     Gets or sets the default timeout for collecting the response for single messages.
        /// </summary>
        /// <value>
        ///     The default timeout for collecting the response for single messages.
        /// </value>
        /// <remarks>
        ///     <note type="implement">
        ///         The default value should be 10 seconds.
        ...
        /// </remarks>
        /// <exception cref="ArgumentOutOfRangeException"> <paramref name="value" /> is negative. </exception>
        TimeSpan DefaultSingleResponseTimeout { get; set; }
        ...
        ///     The result of the task is the response (for a non-broadcast message), the list of responses as a <see cref="List{T}" /> of <see cref="object" /> (for a broadcast message), or just the task to wait until the message has been sent (for fire-and-forget messages).
        /// </returns>
