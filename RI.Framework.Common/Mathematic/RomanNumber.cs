...
namespace RI.Framework.Mathematic
{
    ...
    public struct RomanNumber : IEquatable<RomanNumber>, IComparable<RomanNumber>, IComparable, IFormattable, ICloneable<RomanNumber>, ICloneable, IConvertible
    {
        ...
        bool IConvertible.ToBoolean (IFormatProvider provider) => throw new InvalidCastException("Cannot convert from " + nameof(RomanNumber) + " to " + nameof(Boolean) + ".");

        byte IConvertible.ToByte (IFormatProvider provider) => (byte)this.DecimalValue;

        char IConvertible.ToChar (IFormatProvider provider) => throw new InvalidCastException("Cannot convert from " + nameof(RomanNumber) + " to " + nameof(Char) + ".");

        DateTime IConvertible.ToDateTime (IFormatProvider provider) => throw new InvalidCastException("Cannot convert from " + nameof(RomanNumber) + " to " + nameof(DateTime) + ".");

        decimal IConvertible.ToDecimal (IFormatProvider provider) => this.DecimalValue;

        double IConvertible.ToDouble (IFormatProvider provider) => this.DecimalValue;

        short IConvertible.ToInt16 (IFormatProvider provider) => (short)this.DecimalValue;

        int IConvertible.ToInt32 (IFormatProvider provider) => this.DecimalValue;

        long IConvertible.ToInt64 (IFormatProvider provider) => this.DecimalValue;

        sbyte IConvertible.ToSByte (IFormatProvider provider) => (sbyte)this.DecimalValue;

        float IConvertible.ToSingle (IFormatProvider provider) => this.DecimalValue;

        string IConvertible.ToString (IFormatProvider provider) => this.ToString();

        object IConvertible.ToType (Type conversionType, IFormatProvider provider) => Convert.ChangeType(this.DecimalValue, conversionType, provider);

        ushort IConvertible.ToUInt16 (IFormatProvider provider) => (ushort)this.DecimalValue;

        uint IConvertible.ToUInt32 (IFormatProvider provider) => (uint)this.DecimalValue;

        ulong IConvertible.ToUInt64 (IFormatProvider provider) => (ulong)this.DecimalValue;
    }
}
