...
namespace RI.Framework.IO.INI
{
    ...
    public sealed class IniWriter : IDisposable
	{
		...
		private string EncodeName (string name)
		{
			...
			name = name.Replace(this.Settings.SectionStart.ToString(), this.Settings.EscapeCharacter.ToString() + this.Settings.SectionStart.ToString());
			name = name.Replace(this.Settings.SectionEnd.ToString(), this.Settings.EscapeCharacter.ToString() + this.Settings.SectionEnd.ToString());
			name = name.Replace(this.Settings.CommentStart.ToString(), this.Settings.EscapeCharacter.ToString() + this.Settings.CommentStart.ToString());
			name = name.Replace(this.Settings.NameValueSeparator.ToString(), this.Settings.EscapeCharacter.ToString() + this.Settings.NameValueSeparator.ToString());
			return name;
		}
		...
		private string EncodeSectionName (string sectionName)
		{
			...
			sectionName = sectionName.Replace(this.Settings.SectionStart.ToString(), this.Settings.EscapeCharacter.ToString() + this.Settings.SectionStart.ToString());
			sectionName = sectionName.Replace(this.Settings.SectionEnd.ToString(), this.Settings.EscapeCharacter.ToString() + this.Settings.SectionEnd.ToString());
			return sectionName;
		}
