...
namespace RI.Framework.Bootstrapping
{
    ...
    public abstract class Bootstrapper : LogSource, IBootstrapper
    {
        ...
        ///     </para>
        ///     <note type="note">
        ///         This method is not considered thread-safe.
        ///     </note>
        /// </remarks>
        ...
        {
            FirstStart usedIndicators = indicators ?? Bootstrapping.FirstStart.All;
