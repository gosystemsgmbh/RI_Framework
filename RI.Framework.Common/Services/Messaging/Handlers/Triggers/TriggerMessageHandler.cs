...
namespace RI.Framework.Services.Messaging.Handlers.Triggers
{
    ...
    ///     </para>
    ///     <para>
    ///         Modules or other parts of an application can subscribe to and unsubscribe from a trigger as well as arm or disarm a trigger.
    ...
    ///     </para>
    ///     <para>
    ///         Trigger message names and trigger names are treated case-insensitive.
    ///     </para>
    ///     <note type="note">
    ...
    public sealed class TriggerMessageHandler : LogSource, IMessageReceiver, ISynchronizable
    {
        #region Constants
        ...
        private HashSet<string> ChangedTriggers { get; }

        private TriggerCollection Triggers { get; }
        ...
        /// <inheritdoc />
        public void ReceiveMessage (Message message, IMessageService messageService)
        {
            if (message == null)
            {
