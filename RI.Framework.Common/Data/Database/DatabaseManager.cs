...
namespace RI.Framework.Data.Database
{
        ...
        where TConfiguration : class, IDatabaseManagerConfiguration<TConnection, TTransaction, TConnectionStringBuilder, TManager, TConfiguration>, new()
    {
        ...
        {
            this.Log(LogLevel.Debug, "Performing database backup: [{0}]: {1}", backupTarget, this.DebugDetails);
        ...
        {
            this.Log(LogLevel.Debug, "Performing database cleanup: {0}", this.DebugDetails);
        ...
        {
            this.Log(LogLevel.Debug, "Performing database restore: [{0}]: {1}", backupSource, this.DebugDetails);
        ...
        {
            this.Log(LogLevel.Debug, "Performing database upgrade: {0} -> {1}: {2}", sourceVersion, sourceVersion + 1, this.DebugDetails);
