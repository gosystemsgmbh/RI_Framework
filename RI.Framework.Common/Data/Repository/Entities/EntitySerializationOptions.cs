...
namespace RI.Framework.Data.Repository.Entities
{
    ...
    public enum EntitySerializationOptions
    {
        ...
        /// <summary>
        ///     Everything is serialized (combination of <see cref="Errors" />, <see cref="CreateTracking" />, <see cref="ModifyTracking" />, <see cref="PublicProperties" />, <see cref="SerializationOptions" />).
        /// </summary>
