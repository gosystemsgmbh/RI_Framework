...
{
    /// <summary>
    ///     Implements a base class for entities used with <see cref="IRepositorySet{TEntity}" /> and <see cref="IRepositorySet"/>.
    /// </summary>
    /// <remarks>
    ///     <para>
    ///         <see cref="EntityBase" /> implements basic functionality which might be desirable by entities which are used together with <see cref="IRepositoryContext" />, <see cref="IRepositorySet{TEntity}" />, <see cref="IRepositorySet"/> and/or <see cref="EntityView{TEntity}" />, such as property change notification, change tracking, and error tracking.
    ///     </para>
    ///     <note type="implement">
    ...
    ///         These methods must be overloaded if custom serialization behavior needs to be implemented.
    ///     </note>
    ///     <note type="implement">
    ...
    public abstract class EntityBase : INotifyPropertyChanged, IEntityChangeTracking, IEntityErrorTracking, IDataErrorInfo, INotifyDataErrorInfo, ISerializable, ICloneable
    {
        ...
        private static Dictionary<Type, List<PropertySerializationInfo>> SerializedProperties { get; }
        ...
        public string CreateContext
        {
            ...
            set
            {
                ...
                bool notify = string.Equals(oldValue, value, StringComparison.Ordinal);
        ...
        /// </summary>
        /// <value>
        /// The serialization options for this entity.
        /// </value>
        /// <remarks>
        /// <para>
        /// The default value is <see cref="EntitySerializationOptions.All"/>.
        /// </para>
        /// </remarks>
        ...
        /// <remarks>
        ///     <note type="important">
        ///         The default implementation calls <see cref="object.ToString" /> on <paramref name="changeTrackingContext"/>, often not producing usable results.
        ///     </note>
        /// </remarks>
