...
{
    /// <summary>
    ///     Defines the interface for a repository context, implementing the unit-of-work pattern.
    /// </summary>
    /// <remarks>
    ///     <para>
    ...
    public interface IRepositoryContext : IDisposable
    {
        ...
        ///         If both are providing a value (meaning: not null), the value from <see cref="ChangeTrackingContextResolve" /> is used.
        ///     </para>
        ///     <para>
        ...
        /// <summary>
        ///     Saves all pending changes of all entities and disposes the repository context.
        /// </summary>
        /// <remarks>
        ///     <para>
        ///         The repository context cannot be used afterwards as it will be disposed.
        ///     </para>
        /// </remarks>
