...
namespace RI.Framework.Data.Repository
{
    ...
    ///         Therefore, to serialize and deserialize values in types inheriting from <see cref="RepositorySetErrors" />, you must use <see cref="GetObjectData" /> and <see cref="RepositorySetErrors(SerializationInfo,StreamingContext)" /> (usually automatically used by serializers/deserializers).
    ///     </note>
    /// </remarks>
    ...
    public class RepositorySetErrors : ISerializable
    {
        ...
        {
            this.EntityErrors = new HashSet<string>(StringComparerEx.OrdinalIgnoreCase);
        ...
        /// <summary>
        ///     Gets the set of entity-level validation errors which apply to the entity as a whole.
        /// </summary>
        /// <value>
        ///     The set of entity-level validation errors.
        /// </value>
        /// <remarks>
        ///     <para>
        ///         The set uses <see cref="StringComparerEx.OrdinalIgnoreCase" /> for managing the errors.
        ///     </para>
        /// </remarks>
        public HashSet<string> EntityErrors { get; }
        ...
        ///     </para>
        ///     <para>
        ///         The dictionary uses <see cref="StringComparerEx.OrdinalIgnoreCase" /> for managing the property keys and the errors.
        ///     </para>
        /// </remarks>
        public Dictionary<string, HashSet<string>> PropertyErrors { get; }
