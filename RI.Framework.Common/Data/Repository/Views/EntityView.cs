...
namespace RI.Framework.Data.Repository.Views
{
    ...
    /// TODO: Observe IsReadOnly from IRepositorySet (set and restrict AllowEdit)
        ...
        where TViewObject : EntityViewObject<TEntity>, new()
    {
        ...
        ///     </para>
        /// </remarks>
        /// TODO: Where is the change of this property notified?
        ...
        /// <remarks>
        ///     <note type="important">
        ///         <see cref="Entities" /> might get a new instance of <see cref="ObservableCollection{T}" /> each time <see cref="Update()" /> is called, depending on <see cref="CollectionUpdateStrategy"/>.
        ...
        /// <summary>
        ///     Gets the number of items actually presented by this view, after pagination and filtering is applied to the data source.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        ///     Gets the total number of items presented by this view, before pagination and filtering is applied to the data source.
        /// </summary>
        /// <value>
        ...
        ///     </para>
        ///     <para>
        ///         In order to be observable, the value of <see cref="Source"/> must implement <see cref="INotifyCollectionChanged" />.
        ///     </para>
        /// </remarks>
        ...
        /// <summary>
        ///     Gets the number of pages actually available by this view, after filtering is applied to the data source.
        /// </summary>
        /// <value>
        ///     The total number of pages actually available by this view.
        /// </value>
        /// <remarks>
        ///     <para>
        ...
        ///     </para>
        ///     <para>
        ///         The page number is reset to 1 (if it is not already 0 or 1), when one of the following properties is changed: <see cref="Filter" />, <see cref="Sort"/>, <see cref="PageSize" />, <see cref="Source" />.
        ///     </para>
        ///     <para>
        ...
        /// <summary>
        ///     Gets the total number of pages available by this view, before filtering is applied to the data source.
        /// </summary>
        /// <value>
        ...
        /// </value>
        public IRepositorySet<TEntity> Set { get; }
        ...
        ///     </para>
        ///     <para>
        ///         In order to be updateable, the value of <see cref="Source"/> must implement <see cref="ICollection{TEntity}" />.
        ///     </para>
        /// </remarks>
        ...
        /// <remarks>
        ///     <note type="important">
        ///         <see cref="ViewObjects" /> might get a new instance of <see cref="ObservableCollection{T}" /> each time <see cref="Update()" /> is called, depending on <see cref="CollectionUpdateStrategy"/>.
        ///         See <see cref="Update()" /> for more details.
        ///     </note>
        /// </remarks>
        ...
        /// </summary>
        /// <value>
        ///     true if the entity is attached, false if it is added.
        /// </value>
        ...
        private NotifyCollectionChangedEventHandler EntitiesChangedHandler { get; }

        private NotifyCollectionChangedEventHandler SourceChangedHandler { get; }

        private NotifyCollectionChangedEventHandler ViewObjectsChangedHandler { get; }
        ...
        /// </summary>
        /// <param name="resetPageNumber"> Specifies whether the page number is reset to 1. </param>
        ...
        /// <summary>
        ///     Attaches an existing entity.
        /// </summary>
        /// <param name="entity"> The entity to attach. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="entity" /> is null. </exception>
        /// TODO: Handle inability to attach
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"> <paramref name="entity" /> is null. </exception>
        /// TODO: How can this work if the entity is not yet added to the view...?!?!
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="entity" /> is null. </exception>
        /// TODO: Handle inability to delete
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="entity" /> is null. </exception>
        /// TODO: Handle inability to select
        /// TODO: Handle case if entity is not of this view
        ...
        ///         This cannot be done as the higher context is not known by the <see cref="EntityView{TEntity,TViewObject}" />.
        ///         However, you can do your own save logic by listening to the <see cref="EntityEndEdit" /> event.
        ///     </note>
        /// </remarks>
        /// <exception cref="ArgumentNullException"> <paramref name="entity" /> is null. </exception>
        /// TODO: Handle inability to edit
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="entity" /> is null. </exception>
        /// TODO: Handle inability to modify
        /// TODO: Handle case if entity is not of this view
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="entity" /> is null. </exception>
        /// TODO: Handle inability to reload
        /// TODO: Handle case if entity is not of this view
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException"> <paramref name="entity" /> is null. </exception>
        /// TODO: Handle inability to validate
        /// TODO: Handle case if entity is not of this view
