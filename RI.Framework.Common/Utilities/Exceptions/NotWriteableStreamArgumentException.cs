...
{
	/// <summary>
	///     The <see cref="NotWriteableStreamArgumentException" /> is thrown when a <see cref="Stream" /> argument cannot be written when it should be.
	/// </summary>
	[Serializable]
	...
	public class NotWriteableStreamArgumentException : ArgumentException
	{
		...
		public NotWriteableStreamArgumentException (string paramName, string message)
