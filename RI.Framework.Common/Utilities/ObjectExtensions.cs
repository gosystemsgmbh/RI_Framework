...
namespace RI.Framework.Utilities
{
    ...
    public static class ObjectExtensions
    {
        ...
        /// <summary>
        ///     Attempts to create a deep clone of an object or returns a default value if the object cannot be cloned deeply.
        /// </summary>
        /// <typeparam name="T"> The type of the object to clone. </typeparam>
        /// <param name="obj"> The object to clone. </param>
        /// <returns>
        ///     The deeply cloned object or the default value of <typeparamref name="T" /> if the object cannot be cloned deeply.
        /// </returns>
        /// <remarks>
        ///     <para>
        ///         To perform deep cloning, the object to be cloned is serialized into memory using binary serialization (<see cref="BinaryFormatter" />), and then deserialized.
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException"> <paramref name="obj" /> is null. </exception>
        public static T CloneDeepOrDefault <T> (this T obj)
        {
            return obj.CloneDeepOrDefault(default(T));
        }
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException"> <paramref name="obj" /> is null. </exception>
        public static T CloneDeepOrDefault <T> (this T obj, T defaultValue)
        {
            if (obj == null)
            {
                throw new ArgumentNullException(nameof(obj));
        ...
        /// <summary>
        ///     Attempts to create a deep clone of an object or returns the object uncloned if it cannot be cloned deeply.
        /// </summary>
        /// <typeparam name="T"> The type of the object to clone. </typeparam>
        /// <param name="obj"> The object to clone. </param>
        /// <returns>
        ///     The deeply cloned object oror <paramref name="obj" /> if the object cannot be cloned deeply.
        /// </returns>
        /// <remarks>
        ///     <para>
        ///         To perform deep cloning, the object to be cloned is serialized into memory using binary serialization (<see cref="BinaryFormatter" />), and then deserialized.
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException"> <paramref name="obj" /> is null. </exception>
        public static T CloneDeepOrSelf <T> (this T obj)
        {
            return obj.CloneDeepOrDefault(obj);
        }

        /// <summary>
        ///     Performs a normal clone of an object.
        /// </summary>
        /// <typeparam name="T"> The type of the object to clone. </typeparam>
        /// <param name="obj"> The object to clone. </param>
        /// <returns>
        ...
        public static T Clone <T>(this T obj)
        {
            ...
            throw new NotSupportedException("The object of type " + obj.GetType().Name + " does not support cloning.");
        }
