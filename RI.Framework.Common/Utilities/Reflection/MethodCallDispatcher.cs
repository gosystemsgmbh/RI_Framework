...
namespace RI.Framework.Utilities.Reflection
{
    ...
    public sealed class MethodCallDispatcher
    {
        ...
        /// <summary>
        ///     Creates amethod call dispatcher for a specified type.
        /// </summary>
        ...
        private bool DispatchInternal (object parameter, out object returnValue, Func<string, Type, object> parameterResolver)
        {
            ...
            {
                parameterValues[i1] = parameterResolver(parameters[i1].Name, parameters[i1].ParameterType);
            }
        ...
        private void Initialize (MethodCallDispatcher prototype)
        {
            ...
            this.Methods.AddRange(this.Type.GetMethods(BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic).Where(x => string.Equals(x.Name, this.MethodName, StringComparison.Ordinal)));
