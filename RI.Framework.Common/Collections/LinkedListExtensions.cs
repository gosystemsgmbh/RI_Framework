...
namespace RI.Framework.Collections
{
    ...
    public static class LinkedListExtensions
    {
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"> <paramref name="list" /> is null. </exception>
        public static List<T> ToItemsForward <T>(this LinkedList<T> list) => new List<T>(list.AsItemsForward());
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"> <paramref name="list" /> is null. </exception>
        public static List<T> ToItemsBackward<T>(this LinkedList<T> list) => new List<T>(list.AsItemsBackward());
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"> <paramref name="list" /> is null. </exception>
        public static List<LinkedListNode<T>> ToNodesForward<T>(this LinkedList<T> list) => new List<LinkedListNode<T>>(list.AsNodesForward());
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"> <paramref name="list" /> is null. </exception>
        public static List<LinkedListNode<T>> ToNodesBackward<T>(this LinkedList<T> list) => new List<LinkedListNode<T>>(list.AsNodesBackward());
