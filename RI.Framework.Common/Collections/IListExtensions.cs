...
namespace RI.Framework.Collections
{
	...
	public static class IListExtensions
	{
		...
		public static List<T> RemoveWhere <T> (this IList<T> list, Func<T, bool> condition)
		{
			if (list == null)
			{
				throw new ArgumentNullException(nameof(list));
			...
			List<T> removedItems = new List<T>(list.Count);
		...
		/// </returns>
		/// <exception cref="ArgumentNullException"> <paramref name="list" /> or <paramref name="condition" /> is null. </exception>
		public static List<T> RemoveWhere <T> (this IList<T> list, Func<int, T, bool> condition)
		{
			if (list == null)
			{
				throw new ArgumentNullException(nameof(list));
		...
		{
			list.SwapDefault(indexA, indexB, default(T));
		}
