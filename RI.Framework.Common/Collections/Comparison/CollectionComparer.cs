...
namespace RI.Framework.Collections.Comparison
{
	...
	public sealed class CollectionComparer <T> : IEqualityComparer<IEnumerable<T>>
	{
		...
		/// </value>
		public static CollectionComparer<T> Default { get; private set; }
		...
		///     The collection comparer.
		/// </value>
		public static CollectionComparer<T> DefaultIgnoreOrder { get; private set; }
		...
		///     The collection comparer.
		/// </value>
		public static CollectionComparer<T> ReferenceEquality { get; private set; }
		...
		///     The collection comparer.
		/// </value>
		public static CollectionComparer<T> ReferenceEqualityIgnoreOrder { get; private set; }
