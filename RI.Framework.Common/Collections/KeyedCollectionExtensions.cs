...
namespace RI.Framework.Collections
{
    ...
    public static class KeyedCollectionExtensions
    {
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"> <paramref name="keyedCollection" /> is null. </exception>
        public static TValue GetValueOrDefault<TKey, TValue>(this KeyedCollection<TKey, TValue> keyedCollection, TKey key) => keyedCollection.GetValueOrDefault(key, default(TValue));
