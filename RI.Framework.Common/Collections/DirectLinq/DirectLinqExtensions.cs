...
namespace RI.Framework.Collections.DirectLinq
{
    ...
    public static class DirectLinqExtensions
    {
        ...
        {
            return enumerable.Count(item, EqualityComparer<T>.Default.Equals);
        }
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException"> <paramref name="enumerable" /> or <paramref name="comparer" /> is null. </exception>
        public static int Count<T>(this IEnumerable<T> enumerable, T item, IEqualityComparer<T> comparer)
        {
            if (enumerable == null)
            {
                throw new ArgumentNullException(nameof(enumerable));
            ...
            return enumerable.Count(item, comparer.Equals);
        }
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException"> <paramref name="enumerable" /> or <paramref name="comparer" /> is null. </exception>
        public static int Count<T>(this IEnumerable<T> enumerable, T item, Func<T, T, bool> comparer)
        {
            if (enumerable == null)
            {
                throw new ArgumentNullException(nameof(enumerable));
