...
namespace RI.Framework.Collections.ObjectModel
{
    ...
    public static class ITreeNodeExtensions
    {
        ...
        /// <summary>
        ///     Adds an existing child node to a tree node.
        /// </summary>
        /// <typeparam name="T"> The type of the tree nodes in the tree. </typeparam>
        /// <param name="treeNode"> The tree node. </param>
        /// <param name="child"> The existing child node to add. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="treeNode" /> or <paramref name="child"/> is null. </exception>
        public static void AddChild<T> (this ITreeNode<T> treeNode, T child)
        ...
        /// <summary>
        ///     Adds multiple existing child nodes to a tree node.
        /// </summary>
        /// <typeparam name="T"> The type of the tree nodes in the tree. </typeparam>
        /// <param name="treeNode"> The tree node. </param>
        /// <param name="children"> The sequence of existing child nodes to add. </param>
        /// <returns>
        ///     The number of added child nodes.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        /// <exception cref="ArgumentNullException"> <paramref name="treeNode" /> or <paramref name="children"/> is null. </exception>
        public static int AddChildren<T> (this ITreeNode<T> treeNode, IEnumerable<T> children)
            where T : class, ITreeNode<T>, new()
        {
            if (treeNode == null)
            {
