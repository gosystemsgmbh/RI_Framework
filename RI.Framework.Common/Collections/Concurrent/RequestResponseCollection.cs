        ...
        where TItem : RequestResponseItem<TRequest, TResponse>, new()
    {
        ...
        public int AbortRequests (Exception exception)
        {
            ...
            lock (this.SyncRoot)
            {
                ...
                this.GetRequests().ForEach(x => x.Abort(exception));
                this.ClearRequests();
                return requests;
            }
        }
        ...
        public int CancelRequests ()
        {
            ...
            {
                int requests = this.RequestCount;
                this.GetRequests().ForEach(x => x.Cancel());
                this.ClearRequests();
                return requests;
            }
        }
        ...
        public int DismissConsumers ()
        {
            lock (this.SyncRoot)
            {
                ...
                this.GetConsumers().ForEach(x => x.TrySetCanceled());
                this.ClearConsumers();
                return consumers;
            }
        }
        ...
        public int RespondRequests (TResponse response)
        {
            ...
            {
                int requests = this.RequestCount;
                this.GetRequests().ForEach(x => x.Respond(response));
                this.ClearRequests();
                return requests;
            }
        }
        ...
        public int RespondRequests ()
        {
            ...
            {
                int requests = this.RequestCount;
                this.GetRequests().ForEach(x => x.Respond());
                this.ClearRequests();
                return requests;
            }
        }
