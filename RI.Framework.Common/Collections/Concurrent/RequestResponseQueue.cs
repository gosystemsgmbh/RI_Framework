...
namespace RI.Framework.Collections.Concurrent
{
    ...
    public sealed class RequestResponseQueue <TRequest, TResponse> : RequestResponseCollection<TRequest, TResponse, RequestResponseItem<TRequest, TResponse>>
    {
        ...
        /// <exception cref="TimeoutException"> <paramref name="timeout" /> was reached without a response. </exception>
        /// <exception cref="OperationCanceledException"> <paramref name="ct" /> was triggered. </exception>
        public Task<RequestResponseItem<TRequest, TResponse>> DequeueAsync (TimeSpan timeout, CancellationToken ct) => this.TakeAsync(timeout, ct);
        ...
        /// <exception cref="TimeoutException"> <paramref name="timeout" /> was reached without a response. </exception>
        /// <exception cref="OperationCanceledException"> <paramref name="ct" /> was triggered. </exception>
        public Task<TResponse> EnqueueAsync (TRequest request, TimeSpan timeout, CancellationToken ct) => this.PutAsync(request, timeout, ct);
        ...
        /// <inheritdoc />
        protected override void AddConsumer (TaskCompletionSource<RequestResponseItem<TRequest, TResponse>> consumer) => this.Consumers.Add(consumer);

        /// <inheritdoc />
        protected override void AddRequest (RequestResponseItem<TRequest, TResponse> request) => this.Requests.Add(request);

        /// <inheritdoc />
        protected override void ClearConsumers () => this.Consumers.Clear();

        /// <inheritdoc />
        protected override void ClearRequests () => this.Requests.Clear();
        ...
        /// <inheritdoc />
        protected override IEnumerable<TaskCompletionSource<RequestResponseItem<TRequest, TResponse>>> GetConsumers () => this.Consumers;

        /// <inheritdoc />
        protected override IEnumerable<RequestResponseItem<TRequest, TResponse>> GetRequests () => this.Requests;
        ...
        /// <inheritdoc />
        protected override void RemoveConsumer (TaskCompletionSource<RequestResponseItem<TRequest, TResponse>> consumer) => this.Consumers.Remove(consumer);

        /// <inheritdoc />
        protected override void RemoveRequest (RequestResponseItem<TRequest, TResponse> request) => this.Requests.Remove(request);
