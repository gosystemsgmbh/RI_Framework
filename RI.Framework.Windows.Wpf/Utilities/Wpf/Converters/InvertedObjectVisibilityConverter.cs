...
namespace RI.Framework.Utilities.Wpf.Converters
{
	...
	/// <remarks>
	///     <para>
	///         <see cref="InvertedObjectVisibilityConverter" /> is used when a reference value of any type needs to be used as the visibility for a WPF element.
	///         If the value is null, the converter returns <see cref="Visibility.Visible" />.
	///         If the value is not null, the converter returns its parameter of type <see cref="Visibility" />.
	///         This allows to choose whether <see cref="Visibility.Hidden" /> or <see cref="Visibility.Collapsed" /> is used when the value is not null.
	///     </para>
	///     <para>
