...
namespace RI.Framework.Data.SQLite.Functions
{
    ...
    public sealed class ToNullIfNullOrEmptyOrWhitespaceSQLiteFunction : SQLiteFunction
    {
        ...
        {
            SQLiteFunction.RegisterFunction(typeof(ToNullIfNullOrEmptyOrWhitespaceSQLiteFunction));
        }
