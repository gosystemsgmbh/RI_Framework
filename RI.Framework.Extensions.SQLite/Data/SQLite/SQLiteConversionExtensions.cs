...
{
    /// <summary>
    ///     Provides utility/extension methods for objects returned by SQLite queries.
    /// </summary>
    ...
    public static class SQLiteConversionExtensions
    {
        ...
        /// </returns>
        public static int? ToInt32FromSQLiteResult (this object value)
        {
            if (value == null)
            {
                return null;
        ...
        /// </returns>
        public static long? ToInt64FromSQLiteResult (this object value)
        {
            if (value == null)
            {
                return null;
