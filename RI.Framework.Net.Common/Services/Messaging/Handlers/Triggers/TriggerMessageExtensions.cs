...
namespace RI.Framework.Services.Messaging.Handlers.Triggers
{
    ...
    public static class TriggerMessageExtensions
    {
        ...
        public static bool GetAndTriggered (this Message message)
        {
            if (message == null)
            {
        ...
        public static bool GetOrTriggered (this Message message)
        {
            if (message == null)
            {
                throw new ArgumentNullException(nameof(message));
        ...
        public static string GetSubscriberId (this Message message)
        {
            if (message == null)
            {
                throw new ArgumentNullException(nameof(message));
        ...
        public static string GetTriggerName (this Message message)
        {
            if (message == null)
            {
                throw new ArgumentNullException(nameof(message));
        ...
        public static bool? IsAndTriggered (this Message message, string triggerName)
        {
            if (message == null)
            {
                throw new ArgumentNullException(nameof(message));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="message" /> or <paramref name="triggerName" /> is null. </exception>
        /// <exception cref="EmptyStringArgumentException"> <paramref name="triggerName" /> is an empty string. </exception>
        public static bool? IsOrTriggered (this Message message, string triggerName)
        {
            if (message == null)
            {
                throw new ArgumentNullException(nameof(message));
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"> <paramref name="message" /> is null. </exception>
        public static bool IsTriggerChangedResponse (this Message message)
        {
            if (message == null)
            {
                throw new ArgumentNullException(nameof(message));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="message" /> is null. </exception>
        public static void SetAndTriggered (this Message message, bool state)
        {
            if (message == null)
            {
                throw new ArgumentNullException(nameof(message));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="message" /> is null. </exception>
        public static void SetOrTriggered (this Message message, bool state)
        {
            if (message == null)
            {
                throw new ArgumentNullException(nameof(message));
        ...
        public static void SetSubscriberId (this Message message, string subscriberId)
        {
            if (message == null)
            {
                throw new ArgumentNullException(nameof(message));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="message" /> or <paramref name="triggerName" /> is null. </exception>
        /// <exception cref="EmptyStringArgumentException"> <paramref name="triggerName" /> is an empty string. </exception>
        public static void SetTriggerName (this Message message, string triggerName)
        {
            if (message == null)
            {
                throw new ArgumentNullException(nameof(message));
