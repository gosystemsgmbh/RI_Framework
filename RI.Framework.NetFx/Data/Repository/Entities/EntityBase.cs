...
namespace RI.Framework.Data.Repository.Entities
{
	...
	/// <remarks>
	/// <para>
	/// <see cref="EntityBase"/> implements basic functionality which might be desirable by entities which are used together with <see cref="IRepositoryContext"/> and/or <see cref="EntityView{T}"/>, such as property change notification, change tracking, and error tracking.
	/// </para>
	/// </remarks>
	[Serializable]
