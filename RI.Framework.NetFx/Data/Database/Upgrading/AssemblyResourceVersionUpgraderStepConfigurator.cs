...
namespace RI.Framework.Data.Database.Upgrading
{
	...
	///     </para>
	///     <para>
	///         See <see cref="IAssemblyResourceVersionUpgraderStepConfigurator{TProcessingStep,TConnection,TTransaction,TConnectionStringBuilder,TManager,TConfiguration}" /> for more details.
	///     </para>
	/// </remarks>
