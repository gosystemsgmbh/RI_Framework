...
namespace RI.Framework.Collections.Specialized
{
    ...
    ///         <c> Object.Instantiate(GameObject) </c> is used to create new items from the prefab.
    ///         When a free item is removed from the pool, <c> Object.Destroy(Object) </c> is used to dispose the item.
    ///     </para>
    ///     <para>
    ...
    public sealed class PrefabPool : PoolBase<GameObject>
    {
        ...
        ///     </para>
        ///     <para>
        ///         <c> GameObject.SetActive(bool) </c> is used for activation.
        ///     </para>
        /// </remarks>
        ...
        ///     </para>
        ///     <para>
        ///         <c> GameObject.SetActive(bool) </c> is used for deactivation.
        ///     </para>
        /// </remarks>
