...
namespace RI.Framework.IO.Streams
{
	...
	public sealed class UncloseableStream : Stream
	{
		...
		/// <inheritdoc />
		public override IAsyncResult BeginRead (byte[] buffer, int offset, int count, AsyncCallback callback, object state) => this.BaseStream.BeginRead(buffer, offset, count, callback, state);

		/// <inheritdoc />
		public override IAsyncResult BeginWrite (byte[] buffer, int offset, int count, AsyncCallback callback, object state) => this.BaseStream.BeginWrite(buffer, offset, count, callback, state);
