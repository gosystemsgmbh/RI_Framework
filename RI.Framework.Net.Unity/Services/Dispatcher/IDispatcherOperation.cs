...
namespace RI.Framework.Services.Dispatcher
{
    ...
    /// <remarks>
    ///     <para>
    ///         A dispatcher operation is issued by a <see cref="IDispatcherService" /> when broadcasting or dispatching and can be used to configure or control a pending operation.
    ///     </para>
    /// </remarks>
